 ...
 */
IMAGEIO_EXTERN CGMutableImageMetadataRef CGImageMetadataCreateMutable(void);
 ...
 */
IMAGEIO_EXTERN CGMutableImageMetadataRef CGImageMetadataCreateMutableCopy(CGImageMetadataRef metadata) ;
 ...
 */
IMAGEIO_EXTERN CFTypeID CGImageMetadataTagGetTypeID(void) ;
...
IMAGEIO_EXTERN const CFStringRef  kCGImageMetadataNamespaceExifAux;
IMAGEIO_EXTERN const CFStringRef  kCGImageMetadataNamespaceExifEX;
IMAGEIO_EXTERN const CFStringRef  kCGImageMetadataNamespaceDublinCore;
IMAGEIO_EXTERN const CFStringRef  kCGImageMetadataNamespaceIPTCCore;
IMAGEIO_EXTERN const CFStringRef  kCGImageMetadataNamespacePhotoshop;
IMAGEIO_EXTERN const CFStringRef  kCGImageMetadataNamespaceTIFF;
IMAGEIO_EXTERN const CFStringRef  kCGImageMetadataNamespaceXMPBasic;
IMAGEIO_EXTERN const CFStringRef  kCGImageMetadataNamespaceXMPRights;
...
IMAGEIO_EXTERN const CFStringRef  kCGImageMetadataPrefixExifAux;
IMAGEIO_EXTERN const CFStringRef  kCGImageMetadataPrefixExifEX ;
IMAGEIO_EXTERN const CFStringRef  kCGImageMetadataPrefixDublinCore;
IMAGEIO_EXTERN const CFStringRef  kCGImageMetadataPrefixIPTCCore ;
IMAGEIO_EXTERN const CFStringRef  kCGImageMetadataPrefixPhotoshop ;
IMAGEIO_EXTERN const CFStringRef  kCGImageMetadataPrefixTIFF ;
IMAGEIO_EXTERN const CFStringRef  kCGImageMetadataPrefixXMPBasic;
IMAGEIO_EXTERN const CFStringRef  kCGImageMetadataPrefixXMPRights;
 ...
 */
IMAGEIO_EXTERN CFStringRef CGImageMetadataTagCopyNamespace(CGImageMetadataTagRef tag);

/*!
 * @function CGImageMetadataTagCopyPrefix
 * @abstract Returns a copy of the tag's prefix
 */
IMAGEIO_EXTERN CFStringRef CGImageMetadataTagCopyPrefix(CGImageMetadataTagRef tag);

/*!
 * @function CGImageMetadataTagCopyName
 * @abstract Returns a copy of the tag's name
 */
IMAGEIO_EXTERN CFStringRef CGImageMetadataTagCopyName(CGImageMetadataTagRef tag) ;
 ...
 */
IMAGEIO_EXTERN CFTypeRef CGImageMetadataTagCopyValue(CGImageMetadataTagRef tag);
 ...
 */
IMAGEIO_EXTERN CGImageMetadataType CGImageMetadataTagGetType(CGImageMetadataTagRef tag) ;
 ...
 */
IMAGEIO_EXTERN CFArrayRef CGImageMetadataTagCopyQualifiers(CGImageMetadataTagRef tag) ;
 ...
 */
IMAGEIO_EXTERN CFArrayRef CGImageMetadataCopyTags(CGImageMetadataRef metadata) ;
 ...
 */
IMAGEIO_EXTERN CGImageMetadataTagRef CGImageMetadataCopyTagWithPath(CGImageMetadataRef metadata, CGImageMetadataTagRef parent, CFStringRef path);
 ...
 */
IMAGEIO_EXTERN CFStringRef CGImageMetadataCopyStringValueWithPath(CGImageMetadataRef metadata, CGImageMetadataTagRef parent, CFStringRef path);
 ...
 * or conflict occurs.
 */
IMAGEIO_EXTERN bool CGImageMetadataRegisterNamespaceForPrefix(CGMutableImageMetadataRef metadata, CFStringRef xmlns, CFStringRef prefix, CFErrorRef* err);
 ...
 * @return Returns true if successful, false otherwise.
 */
IMAGEIO_EXTERN bool CGImageMetadataSetValueWithPath(CGMutableImageMetadataRef metadata, CGImageMetadataTagRef parent, CFStringRef path, CFTypeRef value);
...
IMAGEIO_EXTERN const CFStringRef kCGImageMetadataEnumerateRecursively ;
 ...
 */
IMAGEIO_EXTERN CGImageMetadataTagRef
CGImageMetadataCopyTagMatchingImageProperty(CGImageMetadataRef metadata, CFStringRef dictionaryName, CFStringRef propertyName) ;
 ...
 */
IMAGEIO_EXTERN CGImageMetadataRef CGImageMetadataCreateFromXMPData (CFDataRef data);
